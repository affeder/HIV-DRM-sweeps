...
table(dat[dat$newRegimen == "3TC+AZT",]$DRMnum)
table(dat[dat$newRegimen == "AZT",]$DRMnum)
table(dat[dat$newRegimen == "3TC+AZT+IDV",]$DRMnum)
table(dat[dat$newRegimen == "3TC+AZT+LPV",]$DRMnum)

relinds <- intersect(which(dat$newRegimen == "3TC+AZT+NFV"), which(dat$DRMnum <= 4))
plot(dat[relinds,]$DRMnum, dat[relinds,]$ambig)
abline( lm(dat[relinds,]$ambig ~ dat[relinds,]$DRMnum), col = "red", lwd = 2)
...
## hardDRMlist[[507]]
## dat[nclone,]
## which(dat[nclone,]$PtID == 112881)
## prncaa[which(dat[nclone,]$PtID == 112881),73]
## praaalign[which(dat$PtID == 112881),73]
## which(dat$PtID == 112881)


## length(dat[dat$RegimenName == "3TC+AZT",]$DRMnum)
## table(dat[dat$Regimen == "3TC+ABC+ATV+RTV", ]$DRMnum)
## which(dat$PtID == 112881)
## dat[377,]
## dim(dat)
## which(dat$PtID == 118856)
## ncpraaalign[4964,73]
## dat[4964,]
## table(ncpraaalign[,73])
##     ncpraaalign[4964,73]
##     translate(strsplit(dat[4964,]$PRSeq, "")[[1]])
##     praaalign[which(a$PtID == 118856) ]
##     dim(praaalign)
##     which(a$PtID == 118856)
##     praaalign[])
